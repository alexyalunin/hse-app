...
class WorkerManager{
    ...
    init() {
        ...
        let pr4 = Worker(name: "Су́бочев Андрей Николаевич", post: "Преподаватель",worksInOffice: false, faculty: "Факультет экономических наук / Департамент математики", address: "г. Москва, ул. Шаболовка 28, корп. 11, комн. 2083", phone: "+7 (495) 621 13 42", email: "asubochev@hse.ru", timeAvailableInfo: "По договоренности")
        let pr5 = Worker(name: "Шварц Дмитрий Александрович", post: "Преподаватель",worksInOffice: false, faculty: "Факультет экономических наук / Департамент математики", address: "г. Москва, ул. Шаболовка 26, корпус 5, комн.5422", phone: "+7 (495) 621 13 42", email: "dshvarts@hse.ru", timeAvailableInfo: "четверг 15.10-16.30 ауд.534 (ул. Кирпичная); пятница 12.10-13.30 ауд.Л-716К (Покровский б-р, 11) – по предварительному согласованию")
        
        
        workers = [ow1, ow2, ow3, ow4, pr1, pr2, pr3, pr4, pr5, pr1, pr2, pr3, pr4, pr5, pr1, pr2, pr3, pr4, pr5, pr1, pr2, pr3, pr4, pr5]
    }
}
